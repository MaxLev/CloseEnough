...
This package uses two-dimensional particle trajectories to study the spatial distribution of particles relative to surrounding cellular structures. It calculates the nearest distance between each point of a trajectory and surrounding structures represented as a binary masks in reference images. _CloseEnough_ can also randomize the trajectories within a pre-defined area and compare the relative positioning of particles and surrounding structures to a stochastic distribution.
